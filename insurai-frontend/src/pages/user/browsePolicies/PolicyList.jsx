...
export default function PolicyList() {
  ...
  useEffect(() => {
    ...
    const fetchPolicies = async () => {
      ...
      setError(null);
      try {
        // Map slug to API friendly type (e.g., 'health-insurance' -> 'HEALTH-INSURANCE')
        const apiType = policyType.toUpperCase(); 
        
        // This URL maps directly to your new backend controller path: /api/user/browse-policies/{policyType}
